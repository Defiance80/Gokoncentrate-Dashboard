...
<!-- GoKoncentrate Tokens Balance -->
<div class="container mt-4">
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="card bg-body text-center p-4" style="border: 2px solid #f5a623; border-radius: 12px;">
                <div class="d-flex align-items-center justify-content-center gap-3">
                    <div>
                        <img src="{{ asset('img/kt-token-icon.png') }}" alt="KT" style="width: 50px; height: 50px;" onerror="this.style.display='none'">
                    </div>
                    <div>
                        <h6 class="text-muted mb-1">Your Token Balance</h6>
                        <h3 class="mb-0" style="color: #f5a623; font-weight: bold;">
                            KT {{ number_format((auth()->user()->token_balance_cents ?? 0) / 100, 2) }}
                        </h3>
                    </div>
                </div>
                <small class="text-muted mt-2 d-block">Earn tokens by watching content. 1 KT = $1.00 value</small>
            </div>
        </div>
    </div>
</div>
