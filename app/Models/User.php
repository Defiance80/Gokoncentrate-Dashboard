...
class User extends Authenticatable implements HasMedia, MustVerifyEmail
{
    ...
    protected $casts = [
        'user_setting' => 'array',
        'pin' => 'string',
        'token_balance_cents' => 'integer',
    ];

    protected $appends = ['full_name', 'profile_image', 'token_balance'];

    /**
     * Get formatted token balance (e.g., "12.34")
     */
    public function getTokenBalanceAttribute(): string
    {
        return number_format(($this->token_balance_cents ?? 0) / 100, 2, '.', '');
    }
